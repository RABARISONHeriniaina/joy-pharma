 ...
 */
final class Version20231127173146 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Generate slug for categories, products and types entities';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE types ADD slug VARCHAR(255) NOT NULL');
    }
